...
There is only one user in this setup, so I chose the system-wide configuration file.  It is housed in the /etc folder.  You will need to create it using the following command:
